...
NeedsCompilation: no"""
      ...
      expect(packages[1][:depends]).to eq 'DT(>= 0.4), networkD3(>= 0.4), shiny(>= 1.0.5), shinydashboard(>= 0.7.0), magrittr(>= 1.5), Bios2cor(>= 2.0), seqinr(>= 3.4-5), plotly(>= 4.7.1), Hmisc(>= 4.1-1)'
      expect(packages[1][:suggests]).to eq 'randomForest, e1071'
      expect(packages[1][:license]).to eq 'GPL (>= 2)'
      expect(packages[1][:md5sum]).to eq '027ebdd8affce8f0effaecfcd5f5ade2'
